...
def remembersignin():
    findwindow = magic.locateCenterOnScreen(
        "D:\Desktop\Python Documents\TeamsProject\core\staysignedin.png"
    )
    if findwindow == None:
        remembersignin()
    else:
...
def findingcal():
    ...
    try:
        driver.find_element_by_id(
            "app-bar-ef56c0de-36fc-4ef8-b417-3d82ba9d073c"
        ).click()
    except selenium.common.exceptions.NoSuchElementException:
        findingcal()
...
def allow():
    perm = magic.locateCenterOnScreen(
        "D:\Desktop\Python Documents\TeamsProject\core\llow.png"
    )
    if perm == None:
        allow()
    else:
