...
# labels
lblMsg = Label(
    f1, font=("Times New Roman", 16, "bold"), text="MESSAGE", bd=16, anchor="w"
)
...
lblpsd = Label(
    f1, font=("Times New Roman", 16, "bold"), text="PASSWORD KEY", bd=16, anchor="w"
)
...
lblmode = Label(
    f1,
    font=("Times New Roman", 16, "bold"),
    text="MODE(e - Encrypts, d - Decrypts)",
    bd=16,
    anchor="w",
)
...
lblService = Label(
    f1, font=("Times New Roman", 16, "bold"), text="Resulted Message", bd=16, anchor="w"
)
